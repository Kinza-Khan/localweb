        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="feedback.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Feebadck</a>
                    <a href="orders.php" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Orders</a>
                    <a href="Invoice.php" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Invoices</a>
